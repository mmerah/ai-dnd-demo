...
1. If I interact with an NPC using @npc-name then, certain tools are sometimes not called (like party, quest). Or at least, progression through quests/acts is very inconsistent. Need a progression agent ? or more general tool verifier ????? Read docs/FUTURE-AGENTS.md ?
