...
2. Leaner tools: There is a lot of tools right now and we should be able to reduce the amount. For example search_location does essential what a dice check would do. Isn't there too many dice tools ? What about quests ? roll_group_initiative
3. Frontend should use typescript with ban of 'any'.
