...
async def get_schemas() -> dict[str, dict[str, Any]]:
    ...
    return {
        ...
        # Tool result models
        "UpdateHPResult": UpdateHPResult.model_json_schema(),
        "AddConditionResult": AddConditionResult.model_json_schema(),
        "RemoveConditionResult": RemoveConditionResult.model_json_schema(),
        "UpdateSpellSlotsResult": UpdateSpellSlotsResult.model_json_schema(),
        "ModifyCurrencyResult": ModifyCurrencyResult.model_json_schema(),
        "AddItemResult": AddItemResult.model_json_schema(),
        "RemoveItemResult": RemoveItemResult.model_json_schema(),
        "ShortRestResult": ShortRestResult.model_json_schema(),
        "LongRestResult": LongRestResult.model_json_schema(),
        "AdvanceTimeResult": AdvanceTimeResult.model_json_schema(),
        "ChangeLocationResult": ChangeLocationResult.model_json_schema(),
        "DiscoverSecretResult": DiscoverSecretResult.model_json_schema(),
        "UpdateLocationStateResult": UpdateLocationStateResult.model_json_schema(),
        "MoveNPCResult": MoveNPCResult.model_json_schema(),
        "StartCombatResult": StartCombatResult.model_json_schema(),
        "StartEncounterCombatResult": StartEncounterCombatResult.model_json_schema(),
        "SpawnMonstersResult": SpawnMonstersResult.model_json_schema(),
        "NextTurnResult": NextTurnResult.model_json_schema(),
        "EndCombatResult": EndCombatResult.model_json_schema(),
        "AddParticipantResult": AddParticipantResult.model_json_schema(),
        "RemoveParticipantResult": RemoveParticipantResult.model_json_schema(),
        "RollDiceResult": RollDiceResult.model_json_schema(),
        "LevelUpResult": LevelUpResult.model_json_schema(),
        "EquipItemResult": EquipItemResult.model_json_schema(),
        "ToolErrorResult": ToolErrorResult.model_json_schema(),
        "AddPartyMemberResult": AddPartyMemberResult.model_json_schema(),
        "RemovePartyMemberResult": RemovePartyMemberResult.model_json_schema(),
    }
