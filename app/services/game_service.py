...
from app.models.game_state import GameState, CombatState, CombatParticipant, GameTime, Message, MessageRole
...
class GameService:
    ...
    def save_game(self, game_state: GameState) -> str:
        ...
        try:
            ...
            raise IOError(f"Failed to save game {game_state.game_id}: {e}")
    ...
    def add_item(
        ...
        existing_item = next(
            (item for item in inventory if item.name == item_name),
            None
        )
